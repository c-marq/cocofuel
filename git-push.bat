...
echo Setting remote repository to https://github.com/c-marq/cocofuel...
"C:\Program Files\Git\bin\git.exe" remote remove origin 2>nul
"C:\Program Files\Git\bin\git.exe" remote add origin https://github.com/c-marq/cocofuel.git
...
if "%commit_msg%"=="" (
  "C:\Program Files\Git\bin\git.exe" commit -m "Fixed TypeScript errors and added Google Analytics integration"
) else (
